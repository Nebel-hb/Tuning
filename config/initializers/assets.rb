...
Rails.application.config.assets.precompile += %w( shards.js )
Rails.application.config.assets.precompile += %w( modaal.js )
...
Rails.application.config.assets.precompile += %w( multiscroll.min.js )
